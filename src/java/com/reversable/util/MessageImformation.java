 ...
 * @author Ramu Maloth
 */
public class MessageImformation 
{
	private File file;
	...
	public MessageImformation(File file)
	{
		this.file= file;
		isEster= false;
		...
		if(fileExtension.equalsIgnoreCase("jpg"))
			inputMarker= DataHidingScheme.OFFSET_JPG;
		else if(fileExtension.equalsIgnoreCase("png"))
				inputMarker= DataHidingScheme.OFFSET_PNG;
			  else
				inputMarker= DataHidingScheme.OFFSET_GIF_BMP_TIF;
